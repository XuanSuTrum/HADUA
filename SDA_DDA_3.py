...
class Transfer_Net(nn.Module):
    def __init__(self, num_class, base_net='CFE', base_net_eye='CFE_eye', transfer_loss='mmd',
        ...
        # Persistent SoftMatch/UA statistics. This object is created once per
        # target-subject model and therefore keeps EMA state across mini-batches.
    ...
    def forward(self, e, source, target, s_label):
        ...
        # 使用持久化的 SoftMatch/UA 模块；EMA 状态跨 mini-batch 保留
        weights = self.match_weighting.compute_weights(target_clf, e)
